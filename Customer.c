...
#define ENABLE_DETAIL_PRINT

#ifdef ENABLE_DETAIL_PRINT
	#define DETAIL_PRINT(price) printf("Total price for %s is %.2f", pCustomer->name, price);
#else
	#define DETAIL_PRINT(price);  
#endif
